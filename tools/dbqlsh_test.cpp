...
/**
 * @file dbqlsh_test.cpp
 *
 * @brief Example of using Double-Bit Quantization LSH index for L2 distance.
 */
...
int main(int argc, char const *argv[])
{
    if (argc != 4)
    {
        std::cerr << "Usage: ./dbqlsh_test data_file lsh_file benchmark_file" << std::endl;
        return -1;
    }
